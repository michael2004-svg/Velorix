...
import { Mail, Lock, AlertCircle, Zap, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-darker flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Sign in to your contributor account</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full btn-primary py-3 rounded-xl text-white font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
          ...
          <div className="text-center">
            <Link href="#" className="text-violet-400 text-xs hover:text-violet-300 transition-colors">
              Forgot password?
            </Link>
          </div>
        </div>
